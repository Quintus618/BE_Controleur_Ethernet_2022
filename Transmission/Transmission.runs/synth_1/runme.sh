...
HD_PWD='/home/favary/Bureau/xilinx_tps/BE_Controleur_Ethernet_2022/Transmission/Transmission.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ethernet_Controller_src.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ethernet_Controller_src.tcl
