...
HD_PWD='/home/favary/Bureau/xilinx_tps/BE_Controleur_Ethernet_2022/Transmission/Transmission.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ethernet_Controller_src.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ethernet_Controller_src.tcl -notrace
